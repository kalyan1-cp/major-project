...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style18"><span class="style25">Invalid Login Details, Please Try Again!!</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="208" height="174" alt="" class="fl" /></div>
          <div class="post_content">
            <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
              <table width="413" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td width="205" height="62" align="center"><div align="center" class="style19">Name (required)</div></td>
                  <td width="194"><input id="name" name="userid" class="text" /></td>
                </tr>
                <tr>
                  <td height="46" align="center"><div align="center" class="style19">Password (required)</div></td>
