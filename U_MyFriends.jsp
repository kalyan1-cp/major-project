      ...
      <div class="sidebar">
        <div class="gadget">
          <table width="888" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="880"><p class="style18"><span class="style30 style46 style31 style86"><strong>User <span class="style92"><%=(String)application.getAttribute("uname")%></span>'s Friends..</strong></span></p>
                <p class="infopost">&nbsp;</p>                
              </td>
            </tr>
...
<%@ page import="java.util.Date" %>
          ...
          <ul class="sb_menu"><li><table width="913" align="center">
                <tr>
                  <td width="65" height="47" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style33 style49 style93"><span class="style3 ">SlNo. </span></div></td>
                  ...
                  <td width="167" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style36 style70 style93"><strong>Friend Name </strong></div></td>
                  <td width="158" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style34 style50"><span class="style93 style70"><strong>E-mail</strong></span></div></td>
                  <td width="130" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style38 style70 style93"><strong><span class="style3 ">Phone No. </span></strong></div></td>
                  <td width="118" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style38 style70 style93"><strong>DOB</strong></div></td>
				  <td width="125" align="center" valign="middle" bgcolor="#FFFF00"><div align="center" class="style38 style70 style93"><strong>Address</strong></div></td>
                </tr>
                <%
	      ...
	      String s1,s2,s3,s4,s5,s6,s7,user1="";
                ...
                <tr>
                  <td height="104"><div align="center" class="style90"><%=j%></div></td>
