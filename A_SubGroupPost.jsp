...
<head>
<title>SubGroup Post Details..</title>
...
.style48 {color: #FFFFFF; font-weight: bold; font-size: 15px; }
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33"><span class="style1"><span class="style3">  Post </span> <span class="style34"><%=request.getParameter("title")%><span class="style3"> Details</span></span></span><span class="style3">..</span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
try 
	{
		...
		String str="select price,indexs,des,rank,date,unlike from products where (title='"+title+"' and category='"+category+"') and ecompany='"+ecom+"' "; 
...
%>
            ...
            <div class="clr"></div>
  		<p align="right">&nbsp;</p>
  		<p align="center"><a href="A_QueryKeyword.jsp" class="style11 style33"><strong>Back</strong></a></p>
  		<div class="clr">
            <div align="right"></div>
          </div>
        </div>
