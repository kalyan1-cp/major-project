        ...
        <div class="article">
          ...
          <div class="clr"></div>
            ...
            <div>
              ...
              <p>&nbsp;</p>
              <p class="style18 style24"><span class="style44">User Name Already Exist</span>..</p>
              <p class="style18 style24">&nbsp;</p>
              <p align="left"><a href="UserRegister.jsp" class="style11">Back</a></p>
              <p>
                <%
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,status,image) values(?,?,?,?,?,?,?,?,?)");
              ...
              <p class="style19">&nbsp;</p>
              <p><a href="UserLogin.jsp" class="style11">Back</a><a href="index.html" class="style41"></a></p>
              <%
            ...
            <p align="right"><a href="index.html" class="style11"></a></p>
            <div class="clr">
            <div align="right"></div>
          </div>
        </div>
