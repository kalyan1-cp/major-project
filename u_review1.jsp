  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		String strDate="",strTime="",date="",category="",ecom="",id="",rdetails="";
		...
		rdetails=request.getParameter("review");
...
try 
	{
		...
		String str="insert into userreviews(r_by,r_details,p_name,p_id,dt,ecompany)values('"+user+"','"+rdetails+"','"+title+"','"+id+"','"+dt+"','"+ecom+"') "; 
...
%>
		  <h2> PRODUCT REVIEWED SUCCESSFULLY !!! </h2>
