      ...
      <div class="sidebar">
        <div class="gadget">
          <table width="1045" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="1037"><p class="style36 style35 style98">All Products Rating Details.. </p>
          ...
          <div class="templatemo_h_line">
            <table width="1064" border="0" align="center"  cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td  width="146" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Rated User</div></td>
                <td  width="86" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Rated Details</div></td>
              ...
              <%
						...
						try 
						{
							...
							int i=0,j=1,rdetails=0;
						   	String query="select * from userrating  where ecompany='"+ecom+"' "; 
					   		...
					   		while ( rs.next() )
					   		{
								i=rs.getInt(1);
								rby=rs.getString(2);
								rdetails=Integer.parseInt(rs.getString(3));								
                ...
                <td width="106" rowspan="1" align="center" valign="middle" ><div align="center" class="style5 style20 style37 style32 style65 style99 style101">
                    <p class="style18">
					  ...
					  <% if(rdetails==1){%>
                        ...
                        <p class="style77"> <img src="images/2.png" style="width:120px; height:20px;" />
                        <%
							}
							else if(rdetails==3){%>
                        </span></p>
                        <p class="style77"><img src="images/3.png" style="width:120px; height:20px;" />
                        <%
							}
							else if(rdetails==4){%>
                        </span></p>
                        <p class="style77"> <img src="images/4.png" style="width:120px; height:20px;" />
                        <%
							}
							else if(rdetails==5){%>
                        </span></p>
                        <p class="style77"><img src="images/5.png" style="width:120px; height:20px;" />
                        <%
							}else{
							%>
                        </span></p>
                        <p class="style77"><img src="images/0.png" style="width:120px; height:20px;" />
                        <%
							}
							%>
