...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style18"><span class="style12"><span class="style35">View and Authorize Users..</span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
            <p>&nbsp;</p>
            <table width="654" align="center"  cellpadding="0" cellspacing="0"  ">
              ...
              <%
					...
					%>
              <tr>
                <td height="0" align="center"  valign="middle"><div align="center" class="style5 style37 style54 style55 style86">
                    <%out.println(i);%>
                </div></td>
                <td width="116" rowspan="1" align="center" valign="middle" ><div class="style5 style37 style54 style55 style86" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                    <input  name="image" type="image" src="user_Pic.jsp?id=<%=i%>" style="width:90px; height:90px;" />
                </a> </div></td>
                <td height="0" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style86"> 
                    <%out.println(s1);%>
                </div></td>
                <td height="0" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style86"> 
                    <%out.println(s2);%>
                ...
                <%
						...
						%>
                <td valign="middle" height="0" style="color:#000000;"align="center"><div align="center" class="style5 style20 style30 style37 style86">
                    <div align="center" class="style20 style37 style46"><a href="A_UserStatus.jsp?id=<%=i%>" class="style30 style87">waiting</a></div>
                </div></td>
                <%
						}
						else
            ...
            <p align="right">&nbsp;</p>
            <p align="center" class="style84"><a href="AdminMain.jsp" class="style85">Back</a></p>
