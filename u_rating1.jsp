  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		String strDate="",strTime="",date="",category="",ecom="",id="",rating="";
...
try 
	{
		...
		String str="insert into userrating(r_by,rating,p_name,p_id,dt,ecompany)values('"+user+"','"+rating+"','"+title+"','"+id+"','"+dt+"','"+ecom+"') "; 
...
%>
		  <h2> PRODUCT RATED SUCCESSFULLY !!! </h2>
