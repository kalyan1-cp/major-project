      ...
      <div class="sidebar">
        <div class="gadget">
          <table width="1045" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="1037"><p class="style36 style35 style98">All Products and their Details.. </p>
          ...
          <div class="templatemo_h_line">
            <table width="878" border="0" align="center"  cellpadding="0" cellspacing="0">
              <tr>
                <td  width="51" height="34"  valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Si No. </div></td>
                ...
                <td  width="86" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Title</div></td>
                <td  width="106" height="34" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67"><strong>Category</strong></div></td>
                <td  width="62" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Price</div></td>
                <td  width="41" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Vote</div></td>
                <td  width="137" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Index</div></td>
                <td  width="249" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style55 style67">Description</div></td>
              </tr>
              ...
              <%
						...
						try 
						{
							...
							int i=0,j=1;
						   	String query="select id,title,category,price,indexs,des,rank,date from products  where ecompany='"+ecom+"' order by category ASC"; 
              ...
              <tr>
                ...
                <td align="center"  valign="middle"><div align="center" class="style5 style20 style37 style63 style32 style65 style67">
                        ...
                        <textarea name="textarea" cols="20" rows="8"><%out.println(indexs);%></textarea>
                   
                </div></td>
                <td align="center"  valign="middle"><div align="center" class="style5 style20 style37 style63 style32 style65 style67">
                   
                        <textarea name="textarea2" cols="20" rows="8"><%out.println(des);%></textarea>
