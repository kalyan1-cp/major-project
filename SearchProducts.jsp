...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33"><span class="style1"><span class="style3">Search Products.. </span></span><span class="style3"></span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
      
            <p>&nbsp;</p>
            <form action="SearchProducts2.jsp" method="post" id="leavereply">
              <table align="center" style="margin:0 0 0 30px;">
                <tr>
                  ...
                  <td width="200"><div align="left">
                      <input type="text" name="keyword" style="width:200px; height:20px"; placeholder="based on index and description" />
                  </div></td>
                </tr>
                <tr>
                  <td height="61" colspan="2">
                    ...
                    <div align="center">
                      <input name="submit" type="submit" style="width:60px; height:25px;" value="Search"/>
</div></td>
                </tr>
              </table>
              <p class="style44">&nbsp;</p>
