...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33"><span class="style1"><span class="style3">Searched Post </span> <span class="style34"><%=request.getParameter("title")%><span class="style3">'s Details</span></span></span><span class="style3">..</span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		...
		String strDate="",strTime="",date="",category="",ecom="";
		int likes = 0,unlikes=0,i = 0,id;
...
try 
	{
		...
		String str="select id,price,indexs,des,rank,date,unlike,ecompany from products where (title='"+title+"' and category='"+category+"') "; 
            ...
            <table width="666" border="0" align="center" cellpadding="0" cellspacing="0" >
              ...
              <tr>
                ...
                <td valign="top"><div align="center">
                    <p><span class="style9">Votes : </span><span class="style3"><strong><%= likes%></strong></span> </p>
              ...
              <tr>
                ...
                <td><form method="post" action="LikePage.jsp">
                  <label>
                    <div align="center">
                      <p>
                    ...
                    <form method="post" action="UnLikePage.jsp">
                      <label>
                      <div align="center">
                        <p>
                          <input type="hidden" value="<%=title%>" name="title"/>
					...
					<form id="form2" name="form2" method="post" action="u_purchase.jsp">
					
					  <input type="hidden" value="<%=title%>" name="title"/>
                        <input type="hidden" value="<%=id%>" name="id"/>
						 <input type="hidden" value="<%=price%>" name="price"/>
						  <input type="hidden" value="<%=ecom%>" name="ecom"/>
					
                   <input type="submit" name="Submit3" value="Purchase" />
                  </form>	
												
												
												<form id="form4" name="form4" method="post" action="u_review.jsp">
                                                   <input type="hidden" value="<%=title%>" name="title"/>
                        <input type="hidden" value="<%=id%>" name="id"/>
						 <input type="hidden" value="<%=price%>" name="price"/>
						  <input type="hidden" value="<%=ecom%>" name="ecom"/>
                                                    <input type="submit" name="Submit4" value="Review" />
                                                 
                 		 </form>	
						 
						 <form id="form4" name="form4" method="post" action="u_rating.jsp">
                                                   <input type="hidden" value="<%=title%>" name="title"/>
                        <input type="hidden" value="<%=id%>" name="id"/>
						 <input type="hidden" value="<%=price%>" name="price"/>
						  <input type="hidden" value="<%=ecom%>" name="ecom"/>
                                                    <input type="submit" name="Submit4" value="Give Rate" />
...
%>
            ...
            <div class="clr"></div>
  		<p align="right">&nbsp;</p>
  		<p align="center"><a href="SearchProducts.jsp?keyword=<%=keyword%>" class="style11 style33"><strong>Back</strong></a></p>
  		<div class="clr">
            <div align="right"></div>
          </div>
        </div>
