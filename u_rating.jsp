    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		ecom=request.getParameter("ecom");
            ...
            <p align="center" class="style96">RATING DETAILS !!! </p>
            <form id="form1" name="form1" method="post" action="u_rating1.jsp">
              <p>&nbsp;</p>
              <table width="362" border="0">
                ...
                <tr>
                  <td bgcolor="#FFFF00"><span class="style97">Give Your Rating  </span></td>
                ...
                <tr>
                  <td height="45">&nbsp;</td>
                  <td><input type="submit" name="Submit" value="Submit Rate" />
