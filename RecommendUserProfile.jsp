...
<head>
<title>Recommended User Profile..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style33"><span class="style1"><span class="style3">Recommendation User</span> <span class="style34"><%=request.getParameter("username")%><span class="style3">'s</span></span> <span class="style3">Profile</span></span><span class="style3">..</span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
            ...
            <table width="519" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
              ...
              <tr>
                <td  width="119" height="40" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style36 style37" style="margin-left:20px;">
              ...
              <tr>
                <td  width="119" height="40" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style36 style37" style="margin-left:20px;">
              ...
              <tr>
                <td   width="119" height="51" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style36 style37" style="margin-left:20px;">
            ...
            <p align="right"><a href="A_RecommendProducts.jsp" class="style11 style33"><strong>Back</strong></a></p>
            <div class="clr">
            <div align="right"></div>
          </div>
        </div>
