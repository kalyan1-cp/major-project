      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="A_ViewAllProducts.jsp">View All Products  </a></li>
			<li><a href="A_ViewAllReviews.jsp">View All Products's Reviews </a></li>
			<li><a href="A_ViewAllRatings.jsp">View All Products's Ratings </a></li>
			...
			<li><a href="A_RankResults.jsp">View Product Score Results </a></li>
