...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style18">Welcome To User Login</h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/Login.png" width="160" height="160" /></div>
          <div class="post_content">
            <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
              <table width="403" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td width="203" height="62" align="center"><div align="center" class="style19">Name (required)</div></td>
                  <td width="186"><input id="name" name="userid" class="text" /></td>
                </tr>
                <tr>
